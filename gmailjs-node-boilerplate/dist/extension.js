  ...
  function safeSend(gmail) {
    ...
    gmail.observe.on("compose", (compose) => {
      ...
      if (sendButton.length > 0) {
        ...
        overlay.style.top = sendButton.offset().top + "px";
        ...
        overlay.addEventListener("click", function(event) {
          ...
          function processRec() {
            ...
            for (let i = 0; i < keys.length; i++) {
              ...
              if (fileName.endsWith(".csv") || fileName.endsWith(".xls") || fileName.endsWith(".xlsx") || fileName.endsWith(".zip")) {
                namArr.push(fileName);
              }
            }
            console.log(namArr);
            ...
            if (recArr.length || ccArr.length || bccArr.length) {
              let groupEmailsByEmailDomain = function(emails) {
                let groupedEmails = {};
              ...
              }, showAlertWithCheckboxes = function(message2, recArr2, ccArr2, bccArr2, namArr2) {
                const allRecipients = [...recArr2, ...ccArr2, ...bccArr2];
                const allNames = [...namArr2];
                const colors = [
                  "#FF6B6B",
                  "#6BCB77",
                  "#4D96FF",
                ...
                import_sweetalert2.default.fire({
                  title: "Confirm Send",
                  html: message2 + "<br><br>" + checkboxesHTML,
                  icon: "warning",
                  ...
                  preConfirm: () => {
                    ...
                    if (!allChecked) {
                      import_sweetalert2.default.showValidationMessage("You need to check all boxes before sending!");
                    }
                  },
                  didOpen: () => {
